  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Quiz telah berhasil dibuat dan siap digunakan oleh siswa.",
      })
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Buat Quiz Baru</h1>
          <p className="text-muted-foreground">Buat quiz baru dengan mengambil video dari materi yang sudah ada.</p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleSwitchChange("showResultsImmediately", checked)}
                />
              </div>
            </div>
          </CardContent>
