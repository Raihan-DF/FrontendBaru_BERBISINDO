    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex justify-center items-center">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Quiz tidak memiliki soal</h3>
          <Link href="/student/quizzes">
            <Button className="bg-[#8B5CF6] hover:bg-[#7C3AED]">Kembali ke Daftar Quiz</Button>
          </Link>
        </div>
      </div>
    )
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
        <div className="container mx-auto py-4 px-3 sm:py-6 sm:px-4 space-y-4 sm:space-y-6 max-w-4xl">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Quiz Selesai</h1>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-4 sm:p-6 shadow-sm">
            <div className="text-center mb-6">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">{quiz.title} • Quiz Selesai</p>
            </div>

            {/* Statistics */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
              <div className="text-center p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <div className="text-2xl sm:text-3xl font-bold text-blue-600">{results.score}</div>
              ...
              <div className="text-center p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <div className="text-2xl sm:text-3xl font-bold text-green-600">{results.percentage.toFixed(1)}%</div>
            ...
            {isPassingGrade && (
              <div className="text-center mb-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-green-700 dark:text-green-400 font-medium">Selamat! Anda telah lulus quiz ini</p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              ...
              <Link href={`/student/quizzes/${quiz.id}`}>
                <Button variant="outline" className="w-full text-white sm:w-auto bg-transparent bg-[#8B5CF6] hover:bg-[#7C3AED]">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="container mx-auto py-4 px-3 sm:py-6 sm:px-4 space-y-4 sm:space-y-6 max-w-6xl">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Link href={`/student/quizzes/${quiz.id}`}>
            <Button variant="outline" size="icon" className="h-8 w-8 sm:h-10 sm:w-10 shadow-sm bg-transparent">
              <ArrowLeft className="h-4 w-4" />
            </Button>
          </Link>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Kerjakan semua soal dengan teliti</p>
          </div>
          <div className="text-right">
            ...
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Waktu tersisa</div>
          </div>
        </div>
        ...
        <div className="rounded-xl bg-gradient-to-br from-[#8B5CF6] to-[#7C3AED] dark:from-[#5B21B6] dark:to-[#7C3AED] p-4 sm:p-6 shadow-md">
          <div className="grid grid-cols-2 gap-4 text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-1">
              ...
              <p className="text-xs sm:text-sm text-white/90 font-medium">Terjawab</p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="flex justify-center gap-2">
          <Button variant="outline" onClick={() => setShowQuestionNavigation(!showQuestionNavigation)} size="sm">
        ...
        {showQuestionNavigation && (
          <div className="bg-white dark:bg-slate-800 rounded-lg p-3 sm:p-4 shadow-sm">
            <h3 className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white mb-3">Navigasi Soal</h3>
        ...
        <Dialog open={showTimeUpModal} onOpenChange={setShowTimeUpModal}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Waktu quiz telah habis. Quiz akan dikirim dengan jawaban yang sudah Anda kerjakan.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="flex flex-col gap-4 py-4">
              <div className="text-center space-y-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Soal terjawab: <span className="font-semibold text-blue-600">{getAnsweredCount()}</span> dari{" "}
                  {quiz?.questions.length || 0}
                </p>
                <p className="text-xs text-muted-foreground">Jawaban Anda akan disimpan otomatis</p>
              </div>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-xs sm:text-sm">
                Waktu quiz telah habis dan Anda belum menjawab satupun soal. Apa yang ingin Anda lakukan?
              </DialogDescription>
            </DialogHeader>
