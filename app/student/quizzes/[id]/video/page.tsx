...
import { ArrowLeft, ChevronLeft, ChevronRight, Loader2, AlertCircle, RefreshCw, Zap, Target } from "lucide-react"
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex justify-center items-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground">Memuat video quiz...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex justify-center items-center">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
            Quiz tidak memiliki video pembelajaran
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Langsung mulai mengerjakan quiz</p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex justify-center items-center">
        <div className="text-center py-12">
          <Target className="h-16 w-16 text-gray-400 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
            Video tidak tersedia untuk soal ini
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Langsung mulai mengerjakan quiz</p>
          <div className="flex gap-2 justify-center">
            <Link href="/student/quizzes">
      ...
      <div className="container mx-auto py-4 px-3 sm:py-6 sm:px-4 space-y-4 sm:space-y-6 max-w-6xl">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href={`/student/quizzes/${quiz.id}/attempt`}>
              <Button className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-xs sm:text-sm">
        ...
        <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <Link href={`/student/quizzes/${quiz.id}/attempt`} className="block">
              <Button className="w-full bg-[#8B5CF6] hover:bg-[#7C3AED] h-12 text-sm sm:text-base">
                <Zap className="mr-2 h-4 w-4" />
