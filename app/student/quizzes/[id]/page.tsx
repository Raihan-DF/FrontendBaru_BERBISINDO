...
export default function QuizDetailPage({
  ...
  const toggleShowInfo = () => setShowInfo(!showInfo); // Fungsi toggle
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex justify-center items-center">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Quiz yang Anda cari tidak tersedia.
          </p>
      ...
      <div className="container mx-auto py-4 px-3 sm:py-6 sm:px-4 space-y-4 sm:space-y-6 max-w-4xl">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex items-center justify-between cursor-pointer text-sm font-medium text-[#8B5CF6]"
          >
            <span>
              {showInfo ? "Sembunyikan Detail Quiz" : "Tampilkan Detail Quiz"}
            </span>
            {showInfo ? (
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-3 sm:p-4 shadow-sm mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                  ...
                  <span>Deskripsi: {quiz?.description}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
              ...
              <div className="space-y-3">
                ...
                {hasVideos() && (
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 pt-0.5">
                      Tonton video pembelajaran terlebih dahulu untuk pemahaman
                      yang lebih baik
                    </p>
                  </div>
                )}
        ...
        {quiz.attempts && quiz.attempts.length > 0 && (
          <div className="bg-white dark:bg-slate-800 rounded-lg p-3 sm:p-4 shadow-sm">
            ...
            <div className="space-y-3">
              {quiz.attempts
                .slice(-3) // Ambil 3 terakhir dari belakang
                .reverse() // Supaya terbaru ditampilkan paling atas
                .map((attempt, index) => (
                  <div
                    key={attempt.id}
